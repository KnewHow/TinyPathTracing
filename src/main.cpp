...
int main() {
    ...
    std::shared_ptr<Material> mat_letf = std::make_shared<Metal>(tinyMath::vec3f(0.8f));
    std::shared_ptr<Material> mat_right = std::make_shared<Metal>(tinyMath::vec3f(0.8f, 0.6f,0.2f));
    ...
    std::shared_ptr<Object> obj_left = std::make_shared<Sphere>(tinyMath::vec3f(-1.0f, 0.0f, -1.0f), 0.5f, mat_letf);
